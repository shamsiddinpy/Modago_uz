    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_type', models.CharField(choices=[('teligram', 'Telegram'), ('web', 'Web'), ('whatsapp', 'Whatsapp')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('internal', 'Internal'), ('inplace', 'Inplace'), ('teligram', 'Telegram'), ('web', 'Web'), ('instalment', 'Instalment')], max_length=255)),
